...
export const getFxPairs = createAsyncThunk('redux/getFxPairs', async () => {
  const response = await fetch(
    'https://financialmodelingprep.com/api/v3/fx?apikey=23d77ef2fd1549107586543a251b481d',
  );
...
export const getFxPairInfo = createAsyncThunk(
  ...
  async (id) => {
    const response = await fetch(
      `https://financialmodelingprep.com/api/v3/historical-chart/5min/${id}?apikey=23d77ef2fd1549107586543a251b481d`,
